...
>
> $$
> \boxed{\sigma_i^2=\lambda_i(A^TA)=\lambda_i(AA^T)}
> $$
...
>
> $$
> \boxed{\sigma_1=\max_{\|v\|_2=1}\|Av\|_2}
> $$
>
> 또한
>
> $$
> \boxed{\sigma_1=\max_{\|u\|_2=1,\;\|v\|_2=1}u^TAv}
> $$
>
> 이다.
>
...
>
> $$
> \boxed{\sigma_k=\max_{S\subseteq\mathbb{R}^n,\;\dim(S)=k}\min_{v\in S,\;\|v\|_2=1}\|Av\|_2}
> $$
>
> 또한
>
> $$
> \boxed{\sigma_k=\min_{T\subseteq\mathbb{R}^n,\;\dim(T)=n-k+1}\max_{v\in T,\;\|v\|_2=1}\|Av\|_2}
> $$
>
> 이다.
...
>
> $$
> \sigma_k^2=\max_{\dim(S)=k}\min_{v\in S,\;v\neq 0}\frac{v^TA^TAv}{v^Tv}
> $$
>
> 이다.
>
...
>
> $$
> \frac{v^TA^TAv}{v^Tv}=\frac{\|Av\|_2^2}{\|v\|_2^2}
> $$
>
> 이므로
>
> $$
> \sigma_k^2=\max_{\dim(S)=k}\min_{v\in S,\;\|v\|_2=1}\|Av\|_2^2
> $$
>
> 이다.
>
...
>
> $$
> \boxed{\sigma_k=\max_{\dim(S)=k}\min_{v\in S,\;\|v\|_2=1}\|Av\|_2}
> $$
>
> 를 얻는다.
>
...
>
> $$
> \max_{\|u\|_2=1,\;\|v\|_2=1}u^TAv=\max_{\|v\|_2=1}\|Av\|_2=\sigma_1
> $$
>
> 를 얻는다.
> 
